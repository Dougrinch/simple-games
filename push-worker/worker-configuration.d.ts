/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env=production --strict-vars=false` (hash: cecadd03536711f39bc1986cce3a6273)
...
interface __BaseEnv_Env {
	...
	FIREBASE_DATABASE_NAMESPACE: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_URL" | "ALLOWED_ORIGINS" | "FIREBASE_API_KEY" | "FIREBASE_AUTH_BASE_URL" | "FIREBASE_DATABASE_URL" | "FIREBASE_DATABASE_NAMESPACE" | "VAPID_PUBLIC_KEY" | "VAPID_SUBJECT" | "VAPID_PRIVATE_KEY">> {}
}
